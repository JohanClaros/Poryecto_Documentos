    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title" id="myModalLabel">Añadir Personas</h4>
            </div>
            <div class="modal-body">
                <form action="<?= base_url() ?>Admin/insertarPersonas" method="post"  enctype="multipart/form-data">
                    <input type="text" name="nombre" placeholder="Nombre" class="form-control"> <br>
                    <input type="text" name="cargo" placeholder="Cargo" class="form-control"> <br>
...
<?php foreach ($personas as $g) {  ?>
    ...
    <div class="modal fade" id="view<?= $g->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title" id="myModalLabel">Editar Personas</h4>
                </div>
                <div class="modal-body">
                    <form action="<?= base_url() ?>Admin/updatePersonas/<?= $g->id ?>" method="post">
                        <input type="text" name="nombre" value="<?= $g->nombre ?>" class="form-control"> <br>
                        <input type="text" name="cargo" value="<?= $g->cargo ?>" class="form-control"> <br>
                        <button type="submit" class="btn btn-success">Enviar</button>
                    </form>
                </div>
            </div>
    ...
    <div class="modal fade" id="delete<?= $g->id ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>Deseas eliminar <?= $g->nombre ?></p>
                    <a href="<?= base_url() ?>Admin/deletePersonas/<?= $g->id ?>" class="btn btn-success">Eliminar</a>
                </div>
            </div>
        </div>
    </div>
