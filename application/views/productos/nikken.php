	...
	<div class="container-fluid intro" id="about">
		<div class="row">
			<div class="col-md-8 col-md-offset-2">
				<h1 class="chain"><?=$paginas[9]->titulo?></h1>
				<p class="text-intro"><?=$paginas[9]->texto?></p>
			</div>
		</div>
	</div>
			...
			<div id="effect" class="effects clearfix">
				<div class="col-md-4 left nopadding">
					<div class="left-box-1">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8979.jpg" alt="Leather Seats">

						</div>
					</div>
					<div class="left-box-2 box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8972.jpg" alt="Custom Seats">
					...
					<div class="left-box-btm box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8993.jpg" alt="Limited Edition">
				...
				<div class="col-md-4 mid nopadding">
					<div class="mid-box-1 box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8970.jpg" alt="Shop Bags">

						</div>
					</div>
					<div class="mid-box-2 box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8983.jpg" alt="Shop Bikes">
				...
				<div class="col-md-4 right nopadding">
					<div class="right-box-1 box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8971.jpg" alt="Shop Now">

						</div>
					</div>
					<div class="right-box-2 box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8997.jpg" alt="Shop Seats">

						</div>
					</div>
					<div class="right-box-3 box">
						<div class="img">
							<img src="<?= base_url() ?>assets/images/productos/DSC_8984.jpg" alt="Shop Accessories">
